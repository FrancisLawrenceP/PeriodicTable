export const elements = [
    { atomicNumber: 1, symbol: 'H', name: 'Hydrogen', category: 'diatomic nonmetal', group: 1, period: 1 },
    ...
    { atomicNumber: 6, symbol: 'C', name: 'Carbon', category: 'polyatomic nonmetal', group: 14, period: 2 },
    { atomicNumber: 7, symbol: 'N', name: 'Nitrogen', category: 'diatomic nonmetal', group: 15, period: 2 },
    { atomicNumber: 8, symbol: 'O', name: 'Oxygen', category: 'diatomic nonmetal', group: 16, period: 2 },
    { atomicNumber: 9, symbol: 'F', name: 'Fluorine', category: 'diatomic nonmetal', group: 17, period: 2 },
    ...
    { atomicNumber: 15, symbol: 'P', name: 'Phosphorus', category: 'polyatomic nonmetal', group: 15, period: 3 },
    { atomicNumber: 16, symbol: 'S', name: 'Sulfur', category: 'polyatomic nonmetal', group: 16, period: 3 },
    { atomicNumber: 17, symbol: 'Cl', name: 'Chlorine', category: 'diatomic nonmetal', group: 17, period: 3 },
    ...
    { atomicNumber: 34, symbol: 'Se', name: 'Selenium', category: 'polyatomic nonmetal', group: 16, period: 4 },
    { atomicNumber: 35, symbol: 'Br', name: 'Bromine', category: 'diatomic nonmetal', group: 17, period: 4 },
    ...
    { atomicNumber: 53, symbol: 'I', name: 'Iodine', category: 'diatomic nonmetal', group: 17, period: 5 },
    ...
    { atomicNumber: 58, symbol: 'Ce', name: 'Cerium', category: 'lanthanide', group: 3, period: 6 },
    { atomicNumber: 59, symbol: 'Pr', name: 'Praseodymium', category: 'lanthanide', group: 3, period: 6 },
    { atomicNumber: 60, symbol: 'Nd', name: 'Neodymium', category: 'lanthanide', group: 3, period: 6 },
    { atomicNumber: 61, symbol: 'Pm', name: 'Promethium', category: 'lanthanide', group: 3, period: 6 },
    { atomicNumber: 62, symbol: 'Sm', name: 'Samarium', category: 'lanthanide', group: 3, period: 6 },
    { atomicNumber: 63, symbol: 'Eu', name: 'Europium', category: 'lanthanide', group: 3, period: 6 },
    { atomicNumber: 64, symbol: 'Gd', name: 'Gadolinium', category: 'lanthanide', group: 3, period: 6 },
    { atomicNumber: 65, symbol: 'Tb', name: 'Terbium', category: 'lanthanide', group: 3, period: 6 },
    { atomicNumber: 66, symbol: 'Dy', name: 'Dysprosium', category: 'lanthanide', group: 3, period: 6 },
    { atomicNumber: 67, symbol: 'Ho', name: 'Holmium', category: 'lanthanide', group: 3, period: 6 },
    { atomicNumber: 68, symbol: 'Er', name: 'Erbium', category: 'lanthanide', group: 3, period: 6 },
    { atomicNumber: 69, symbol: 'Tm', name: 'Thulium', category: 'lanthanide', group: 3, period: 6 },
    { atomicNumber: 70, symbol: 'Yb', name: 'Ytterbium', category: 'lanthanide', group: 3, period: 6 },
    { atomicNumber: 71, symbol: 'Lu', name: 'Lutetium', category: 'lanthanide', group: 3, period: 6 },
    ...
    { atomicNumber: 85, symbol: 'At', name: 'Astatine', category: 'metalloid', group: 17, period: 6 },
    ...
    { atomicNumber: 90, symbol: 'Th', name: 'Thorium', category: 'actinide', group: 3, period: 7 },
    { atomicNumber: 91, symbol: 'Pa', name: 'Protactinium', category: 'actinide', group: 3, period: 7 },
    { atomicNumber: 92, symbol: 'U', name: 'Uranium', category: 'actinide', group: 3, period: 7 },
    { atomicNumber: 93, symbol: 'Np', name: 'Neptunium', category: 'actinide', group: 3, period: 7 },
    { atomicNumber: 94, symbol: 'Pu', name: 'Plutonium', category: 'actinide', group: 3, period: 7 },
    { atomicNumber: 95, symbol: 'Am', name: 'Americium', category: 'actinide', group: 3, period: 7 },
    { atomicNumber: 96, symbol: 'Cm', name: 'Curium', category: 'actinide', group: 3, period: 7 },
    { atomicNumber: 97, symbol: 'Bk', name: 'Berkelium', category: 'actinide', group: 3, period: 7 },
    { atomicNumber: 98, symbol: 'Cf', name: 'Californium', category: 'actinide', group: 3, period: 7 },
    { atomicNumber: 99, symbol: 'Es', name: 'Einsteinium', category: 'actinide', group: 3, period: 7 },
    { atomicNumber: 100, symbol: 'Fm', name: 'Fermium', category: 'actinide', group: 3, period: 7 },
    { atomicNumber: 101, symbol: 'Md', name: 'Mendelevium', category: 'actinide', group: 3, period: 7 },
    { atomicNumber: 102, symbol: 'No', name: 'Nobelium', category: 'actinide', group: 3, period: 7 },
    { atomicNumber: 103, symbol: 'Lr', name: 'Lawrencium', category: 'actinide', group: 3, period: 7 },
